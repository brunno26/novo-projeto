...
<head>
  ...
  <style>
    /* Adicionado para definir a cor de fundo purple */
    body {
      background-color: purple; /* Você pode usar um código hexadecimal como #800080 para um tom específico de purple */
      background-image: none; /* Garante que nenhum gradiente padrão seja aplicado */
    }
  </style>
</head>

<body> <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;">
    <div class="col-12">
            ...
            <div class="col-lg-7">
              <div class="p-5">
                ...
                <form class="user" action="index.php" method="post">
                  ...
                  <button class="btn btn-primary btn-user btn-block btn-purple" name="login" type="submit">
