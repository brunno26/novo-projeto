        ...
        <main>
            <div class="main-content-wrapper">
                <div class="container d-flex justify-content-center align-items-center form-container">
                    <form class="row p-3 m-3 shadow-lg" method="post" action="index.php">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="reset" class="btn"><i class="bi bi-x-circle"></i> Apagar</button>
                            <button type="submit" name="inserir_usuario" class="btn"><i class="bi bi-floppy"></i> Salvar</button>
                        </div>
                    </form>
                </div>
            </div> </main>
