...
<html lang="pt-br">
    <head>
        <title>Cadastro de bandeiras de cartões</title>
        <meta charset="utf-8" />
        <meta
            name="viewport"
                ...
                <div class="container d-flex justify-content-center align-items-center form-container"> 
                    <form class="row p-3 m-3 rounded shadow-lg" method="post" action="index.php">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="reset" class="btn"><i class="bi bi-eraser"></i> Apagar</button>
                            <button type="submit" name="inserir_bandeira" class="btn"><i class="bi bi-check-lg"></i> Salvar</button>
                        </div>
                    </form>
                </div>
            </div> </main>
