            ...
            <div class="modal-content p-4">
                ...
                <div class="modal-body">
                    <form class="row" method="post" action="index.php" id="lancamentoForm">
                        <input type="hidden" name="id_cad_tipo" id="tipo_lanc_hidden" value="">

                        <div class="form-group col-12 mb-3">
                            <label for="plano_contas" class="form-label">Plano de contas:</label>
                            <select class="form-control" name="id_cad_plano" id="plano_contas" required>
                                <?php $objController->selectPlano(); ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-12 mb-3">
                            ...
                            <select class="form-control" name="id_cad_forma" id="cad_forma">
                                <?php $objController->selectForma(); ?>
                            </select>
                        </div>
